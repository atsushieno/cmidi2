...
As of v0.3.1, every function is static inline (if you are familiar with [LV2](lv2plug.in/) you would notice that this implementation style is quite simiar to it, namely LV2 Atom).
