# cmidi2: tiny MIDI 2.0 UMP and MICI-CI binary processor library
...
As of v0.3.1, every function is static inline (if you are familiar with [LV2](lv2plug.in/) you would notice that this implementation style is quite simiar to it).
...
[atsushieno/android-audio-plugin-framework](https://github.com/atsushieno/android-audio-plugin-framework/), [atsushieno/aap-lv2](https://github.com/atsushieno/aap-lv2), and [atsushieno/aap-juce](https://github.com/atsushieno/aap-juce) makes use of this library.
